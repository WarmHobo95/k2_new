...
abstract class $ProductsCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String car_color, String price});
}
...
class _$ProductsImpl implements _Products {
  _$ProductsImpl(
      {required this.id, required this.car_color, required this.price});
  ...
  @override
  String toString() {
    return 'Products(id: $id, car_color: $car_color, price: $price)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, car_color, price);
...
abstract class _Products implements Products {
  factory _Products(
      ...
      required final String price}) = _$ProductsImpl;
